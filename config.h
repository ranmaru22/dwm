...
static const char *fonts[]               = { "Sarasa Term J:size=10", "Iosevka Nerd Font:size=10" };
static const char dmenufont[]            = "Sarasa Term J:size=10";
static const char col_gray1[]            = "#18181b";
static const char col_gray2[]            = "#33333a";
static const char col_gray3[]            = "#879193";
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_y,      spawn,          {.v = passmenucmd} },
  { MODKEY|ShiftMask,             XK_y,      spawn,          {.v = pmotpcmd} },
